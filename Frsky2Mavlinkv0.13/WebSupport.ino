...
//=================================================================================
  ...
  settingsPage += "<!DOCTYPE html><html><body><h>Passthrough To Mavlink</h><form action='' ";  
  settingsPage += "autocomplete='on'> <center> <b><h3>Passthrough2Mavlink Setup</h3> </b></center> <style>text-align:left</style>";
  settingsPage += "<br><br>GCS IO: &nbsp";
