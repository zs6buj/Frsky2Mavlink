 ...
 switch(fr_payloadType) {
   ...
   case 0x800:                      // Latitude and Longitude
               ...
               //    fr_vdop = bit32Extract(fr_payload, 15, 7) * TenToPwr(bit32Extract(fr_payload, 14, 1)); 
                  ...
                  fr_gps_alt = bit32Extract(fr_payload,24,7) * TenToPwr(bit32Extract(fr_gps_alt,22,2)); //-- dm
                  fr_gps_alt*=10;
                ...
                //   fr_gps_alt = bit32Extract(fr_payload, 16, 16);  //  For use with modified arducopter 3.5.5
                 ...
                 case 0x5003:                         // Battery 1 Hz
                   ...
                   fr_bat_amps = bit32Extract(fr_payload,10,7) * TenToPwr(bit32Extract(fr_payload,9,1));
                 ...
                 case 0x5004:                         // Home 2 Hz
                   ...
                   fr_home_alt = bit32Extract(fr_payload,14,10) * TenToPwr(bit32Extract(fr_payload,12,2));
